...
const ExpenseTracker = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await axios.get("https://business-portal-app-plum.vercel.app/api/auth/users", {
        headers: {
  ...
  const handleAddUser = async () => {
    try {
      ...
      const { data } = await axios.post(
        "https://business-portal-app-plum.vercel.app/api/auth/users",
        newUser,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleAddTransaction = async (userId) => {
    try {
      ...
      const { data } = await axios.post(
        `https://business-portal-app-plum.vercel.app/api/auth/users/${userId}/transactions`,
        transaction,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDeleteTransaction = async (userId, index) => {
    try {
      const token = localStorage.getItem("authToken");
      await axios.delete(
        `https://business-portal-app-plum.vercel.app/api/auth/users/${userId}/transactions/${index}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleDeleteUser = async (userId) => {
    try {
      const token = localStorage.getItem('authToken');
      await axios.delete(`https://business-portal-app-plum.vercel.app/api/auth/users/${userId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
